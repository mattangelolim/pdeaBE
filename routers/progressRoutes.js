...
router.get("/progress/report", async (req, res) => {
    try {
        ...
        console.log(allProgressReports)
        ...
        const combinedData = allProgressReports.map(report => {
            ...
            // console.log(drugPerson.Classification_Rating)
            ...
            return {
                ...
                status: drugPerson && drugPerson.Classification_Rating !== 0 ? getRatingWord(drugPerson.Classification_Rating) : 'Not Set',
